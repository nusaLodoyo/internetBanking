...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Laporan Lanjutan iBanking : Deposito</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="pages_dashboard.php">Dasbor</a></li>
                <li class="breadcrumb-item"><a href="pages_financial_reporting_deposits.php">Laporan Lanjutan</a></li>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4>Semua Transaksi dalam Kategori Deposito</h4>
              </div>
              <div class="card-body">
                <table id="export" class="table table-hover table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    // Dapatkan transaksi deposit terbaru
                    ...
                    ?>
                      ...
                      <tr>
                        ...
                        <td>Rp. <?php echo number_format($row->transaction_amt, 0, '.', '.'); ?></td> <!-- Menambahkan Rp. dan titik -->
                        <td><?php echo $row->client_name; ?></td>
                        <td><?php echo $row->keterangan; ?></td> <!-- Menambahkan kolom Keterangan -->
  ...
  <!-- Data Tables V2.01 -->
  <!-- CATATAN: Untuk Menggunakan Opsi Copy, CSV, Excel, PDF, dan Print, Anda Harus Sertakan File-file Ini -->
