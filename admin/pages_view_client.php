...
if (isset($_POST['update_client_account'])) {
    ...
    if ($stmt) {
        $success = "Akun Santri Diperbarui";
    } else {
        $err = "Silahkan Coba Lagi Nanti";
    }
}
//change password
if (isset($_POST['change_client_password'])) {
    ...
    //declare a varible which will be passed to alert function
    if ($stmt) {
        $success = "Password Santri Diperbarui";
    } else {
        $err = "Silahkan Coba Lagi Nanti";
    }
}
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_manage_clients.php">Profil Santri</a></li>
                                    ...
                                    <div class="card-body box-profile">
                                        ...
                                        <ul class="list-group list-group-unbordered mb-3">
                                            <li class="list-group-item">
                                                <b>NIK: </b> <a class="float-right"><?php echo $row->national_id; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Email: </b> <a class="float-right"><?php echo $row->email; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Kontak Wali Santri: </b> <a class="float-right"><?php echo $row->phone; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Nomor Induk: </b> <a class="float-right"><?php echo $row->client_number; ?></a>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Kelas: </b> <a class="float-right"><?php echo $row->address; ?></a>
                                            </li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="update_Profile">
                                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputName2" class="col-sm-2 col-form-label">Kontak Wali Santri</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="input-group col-sm-10">
                                                            <div class="custom-file">
                                                                ...
                                                                <label class="custom-file-label  col-form-label" for="exampleInputFile">Pilih file</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="offset-sm-2 col-sm-10">
                                                            <button name="update_client_account" type="submit" class="btn btn-outline-success">Perbarui Akun</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <div class="tab-pane" id="Change_Password">
                                                <form method="post" class="form-horizontal">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="offset-sm-2 col-sm-10">
                                                            <button type="submit" name="change_client_password" class="btn btn-outline-success">Ganti Password</button>
                                                        </div>
                                                    </div>
